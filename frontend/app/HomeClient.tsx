...
import type { TestInfo } from '@/utils/api';

const CATEGORIES = ['All', 'Health', 'Personality', 'Fun'];

export default function HomeClient({ initialTests }: { initialTests: TestInfo[] }) {
  ...
  const featuredTest = initialTests.find((t) => t.isFeatured) || initialTests[0];
