...
export default function LandingPage() {
    ...
    const filteredTests = INITIAL_TESTS.filter((test) => {
        ...
        // Exclude featured item from the grid list? Usually Hero is distinctive. 
        // Let's keep it in the list or exclude it? Requirement says "separate it from the list below".
        // I will exclude the featured item from the list to avoid duplication if it's the same context.
...
{/* 2A. Hero Section */ }
{
    featuredTest && (
        <section className=\"mb-12 rounded-3xl overflow-hidden shadow-2xl relative text-white\">
            < div className = {`absolute inset-0 ${featuredTest.image} opacity-90 bg-gradient-to-r from-blue-900 to-blue-600`
}></div >
