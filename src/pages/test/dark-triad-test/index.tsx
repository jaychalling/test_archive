...
import { ChevronLeft, ChevronRight, CheckCircle2, Skull } from "lucide-react";
...
const DarkTriadTest = () => {
  ...
  const totalQuestions = darkTriadQuestions.length;
  ...
  const handleSubmit = () => {
    localStorage.setItem('darkTriadAnswers', JSON.stringify(answers));
    navigate('/test/dark-triad-test/result/');
  };
        ...
        <>
          ...
          <main className="flex-1 flex items-center justify-center px-4 py-8">
            <div className="max-w-lg mx-auto test-card text-center animate-scale-in">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Dark Triad Test</h1>
              <p className="text-lg text-muted-foreground mb-8">
                Explore your darker personality traits.
                <br />
                Narcissism, Machiavellianism, and Psychopathy.
              </p>

              <div className="bg-muted/50 p-6 rounded-lg mb-8 text-left">
                <h2 className="font-semibold text-lg mb-3">About the Dark Triad</h2>
                <ul className="space-y-3 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <span className="text-rose-500 mt-0.5">•</span>
                    <span><strong className="text-foreground">Narcissism:</strong> Self-admiration, desire for attention, sense of superiority</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-violet-500 mt-0.5">•</span>
                    <span><strong className="text-foreground">Machiavellianism:</strong> Strategic manipulation, cynicism, prioritizing personal gain</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-slate-500 mt-0.5">•</span>
                    <span><strong className="text-foreground">Psychopathy:</strong> Emotional detachment, impulsivity, reduced empathy</span>
                  </li>
                </ul>
              </div>
        ...
        <>
          ...
          <div className="px-4 py-3 flex items-center justify-between border-b border-border/50 bg-background/80 backdrop-blur-sm">
            <Link to="/" className="flex items-center gap-2 hover:opacity-70 transition-opacity">
              ...
              <span className="text-sm font-medium text-foreground">Dark Triad</span>
            </Link>
          ...
          <main className="flex-1 flex flex-col justify-center px-4 py-6">
            <div className="max-w-lg mx-auto w-full">
              ...
              >
                {(() => {
                  const question = darkTriadQuestions[currentQuestion];
                  return (
