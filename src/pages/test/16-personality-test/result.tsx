...
import { CheckCircle2, RotateCcw, Share2, Layers, BookOpen, Lightbulb } from "lucide-react";
...
const SixteenPersonalityTestResult = () => {
  ...
  useEffect(() => {
    ...
    if (savedAnswers) {
      ...
      navigate('/test/16-personality-test/');
    }
  }, [navigate]);
...
export default SixteenPersonalityTestResult;
